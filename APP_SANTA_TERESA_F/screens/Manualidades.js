...
const ManualidadesScreen = ({ navigation }) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.buttonContainer}>
        <TouchableOpacity
          style={styles.button}
          onPress={() => navigation.navigate('FormularioManualidades')}
        >
          <Text style={styles.buttonText}>Registrar Manualidad</Text>
        </TouchableOpacity>
        <TouchableOpacity
          style={styles.button}
          onPress={() => navigation.navigate('ListaManualidades')}
        >
          <Text style={styles.buttonText}>Ver Manualidades Vendidas</Text>
        </TouchableOpacity>
      </View>
...
export default ManualidadesScreen;
